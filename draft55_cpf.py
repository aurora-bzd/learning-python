...
# replace - o primei arg eh oq vc quer substituir, e o segundo arg sera a substituicao

cpf_enviado_cliente = re.sub(
    r'[^0-9]',  #substitui qualquer coisa q nao eh um numero por nada
    '',
    entrada
    )
...
if cpf_enviado_cliente == cpf_gerado_pelo_calculo:
    print(f'{cpf_enviado_cliente} eh valido')
else:
    print('CPF invalido')
